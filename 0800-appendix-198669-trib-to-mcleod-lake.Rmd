...
Approximately 2.1km upstream of the `r fpr_my_pscis_info(col_pull = road_name, site = my_site)` crossing, PSCIS crossing `r as.character(my_site2)` was located on an unnamed FSR. Although ranked as a barrier to upstream fish passage according to the provincial protocols [@moe2011Fieldassessment], the crossing was backwatered 30% and is not likely a barrier to fish passage.  The culvert was poorly installed and in a deteriorated condition, resulting in significant upstream water backup. Habitat was considered medium value, characterized by dense riparian vegetation including shrubs and ferns. Detailed results are provided in [Appendix - Phase 1 Fish Passage Assessment Data and Photos].
