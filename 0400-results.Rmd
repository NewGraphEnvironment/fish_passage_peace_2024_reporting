...
Fish sampling was completed all both habitat confirmation sites as well as several monitoring sites.
...
Results are presented in detail within the individual habitat confirmation site appendices in this report and in past reports for the monitoring sites, which can be accessed by searching the site number in Table \@ref(tab:tab-sites-cap) and clicking the Link Report.
