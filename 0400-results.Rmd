...
Fish passage assessment procedures conducted through FWCP in the Peace River Region since 2019 are amalgamated `r if(identical(gitbook_on, FALSE)){knitr::asis_output(paste0("online within the Results and Discussion section of the report found ", ngr::ngr_str_link_url(url_base = params$report_url, anchor_text = "here")))}else{knitr::asis_output("in Tables \\@ref(tab:tab-sites-sum-cap) - \\@ref(tab:tab-sites-cap).")}`
...
- Following the 2022 replacement of Tributary to Missinka (PSCIS crossing 125179) on Chuchinka-Missinka FSR, effectiveness monitoring was conducted in 2024. Background can be reviewed [here](https://www.newgraphenvironment.com/fish_passage_peace_2022_reporting/) with results of the monitoring presented in [Tributary to Missinka River - 125179 - Appendix](#trib-to-missinka).

- In the summer of 2024, Tributary to Table crossing (PSCIS crossing 125131) on Chuchinka-Table FSR was replaced, with effectiveness monitoring conducted in the fall of 2024. Background information and results of the monitoring can be reviewed [here](https://www.newgraphenvironment.com/fish_passage_peace_2023_reporting/tributary-to-the-table-river---125231---appendix.html).
