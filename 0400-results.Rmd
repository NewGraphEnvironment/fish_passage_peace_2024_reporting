...
No new designs were commissioned in 2024.  All sites with a design for remediation of fish passage can be found in Table \@ref(tab:tab-sites-cap) by filtering using Design = yes. 
...
All sites where remediation of fish passage has been completed since 2019 can be found in Table \@ref(tab:tab-sites-cap) by filtering using Remediation = yes.


## Monitoring

In 2024, baseline or follow up monitoring data was gathered at four sites:
