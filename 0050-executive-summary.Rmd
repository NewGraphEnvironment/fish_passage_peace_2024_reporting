...
Fish passage assessment procedures conducted through SERNbc in the Peace River Watershed since 2020 are amalgamated `r if(identical(gitbook_on, FALSE)){knitr::asis_output(paste0("within Table \\@ref(tab:tab-sites-sum-kable) - with detailed outputs located online within the Results and Discussion section of the online report found ", ngr::ngr_str_link_url(url_base = params$report_url, anchor_text = "here")))}else{knitr::asis_output("in Tables \\@ref(tab:tab-sites-sum-kable) - \\@ref(tab:tab-sites-cap)")}`, 
which includes links to project reporting for each site.  

<br>

In 2024, fish passage assessments were conducted at 15 sites—11 new Phase 1 sites and 4 reassessments—using the Provincial Stream Crossing Information System (PSCIS). Assessments focused on identifying structures that may pose barriers to upstream fish movement, following standard provincial criteria.
