...
Some sites are linked incorrectly in bcfishpass, see issue here https://github.com/NewGraphEnvironment/fish_passage_peace_2024_reporting/issues/7. We have a work around for now where we use the `bcfishpass.crossings_vw` layer form the `sern_peace_fwcp_2023` GIS project instead of pulling directly from bcfishpass.
...
##### HACK FOR THE TIME BEING, UNTIL THE ABOVE ISSUE GETS FIXED #####
